...
import { autocompleteData, DataSvcService } from '../data-svc.service';



@Component({
  selector: 'app-many-spread-view',
  templateUrl: './many-spread-view.component.html',
  styleUrls: ['./many-spread-view.component.scss']
})
export class ManySpreadViewComponent implements OnInit {
